    ...
    <section id="contact" className="py-16 md:py-24 overflow-hidden relative bg-gradient-to-b from-[#000000] via-[#0A1628] to-[#000000]">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <FadeIn className="text-center max-w-4xl mx-auto mb-16">
          ...
          <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 text-theme-primary">
          ...
          <FadeIn className="lg:col-span-7">
            <div className="p-8 md:p-10 rounded-3xl backdrop-blur-xl bg-gradient-to-br from-white/10 via-white/5 to-transparent border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.3)] relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-3xl md:text-4xl font-bold mb-3 text-theme-primary">Tell Us About Your Project</h3>
